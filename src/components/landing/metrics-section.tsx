    ...
    <section className="py-8">
      <PageContainer>
        <div className="grid gap-4 rounded-[34px] border border-orange-100 bg-white p-6 shadow-sm md:grid-cols-2 xl:grid-cols-4">
          ...
          <div><p className="font-heading text-4xl font-extrabold text-orange-500"><AnimatedCounter value={3} suffix="x" /></p><p className="mt-2 text-sm text-slate-600">mais clareza na gestão</p></div>
