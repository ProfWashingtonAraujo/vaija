    ...
    <Dialog>
      ...
      <DialogContent
        className={cn(
          ...
          side === 'bottom' && 'left-1/2 top-auto bottom-0 max-h-[92dvh] w-[calc(100%-1rem)] max-w-2xl -translate-x-1/2 translate-y-0 overflow-y-auto rounded-b-none rounded-t-[32px]',
        )}
      >
        {children}
      </DialogContent>
