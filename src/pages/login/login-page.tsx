        ...
        <div className="p-6 sm:p-10">
          ...
          <div className="mt-8 rounded-[30px] border border-orange-100 bg-gradient-to-br from-white to-[#fffaf5] p-1 shadow-[0_20px_46px_rgba(15,23,42,0.06)]">
            <form onSubmit={handleSubmit(onSubmit)} className="rounded-[28px] bg-white/90 p-6 sm:p-8">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">Acesse sua conta para gerenciar seu restaurante.</p>
              ...
              <p className="mt-6 text-center text-sm text-slate-500">Voltar para a <Link to="/" className="font-semibold text-orange-700">landing page</Link></p>
            </form>
          </div>
        </div>
      </div>
